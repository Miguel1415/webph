document.addEventListener('DOMContentLoaded', () => {
    ...
    videoContainers.forEach(container => {
        ...
        if (video && playPauseBtn && volumeSlider) {
            ...
            // Update button icon when video plays/pauses externally (e.g., by user interaction or autoplay)
            ...
            // Mute video initially and set volume from slider
            video.muted = true;
            video.volume = volumeSlider.value;
        }
    });
